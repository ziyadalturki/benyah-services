...
> = {
  ...
  ar: {
    invalidRequest: "ما قدرنا نقرأ البيانات المرسلة.",
    validation: "راجع الحقول المحددة وحاول مرة ثانية.",
    server: "صار خطأ أثناء معالجة الطلب.",
    nameRequired: "أدخل الاسم.",
    nameInvalid: "أدخل اسماً صحيحاً.",
    companyRequired: "أدخل اسم الشركة.",
    companyInvalid: "أدخل اسم شركة صحيحاً.",
    emailRequired: "أدخل البريد الإلكتروني.",
    emailInvalid: "أدخل بريداً إلكترونياً صحيحاً.",
    phoneInvalid: "أدخل رقم هاتف أو واتساب صحيحاً.",
    serviceRequired: "اختر الخدمة الأقرب لاحتياجك.",
    serviceInvalid: "اختر خدمة صحيحة.",
    briefRequired: "أضف وصفاً مختصراً للمشروع.",
    briefInvalid: "أضف وصفاً عملياً لا يقل عن 20 حرفاً.",
    nextStepInvalid: "اختر طريقة بداية صحيحة.",
  },
};
