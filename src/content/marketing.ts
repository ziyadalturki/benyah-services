...
export const marketingContent: Record<Locale, MarketingContent> = {
  ...
  ar: {
    meta: {
      ...
      mobileNavigationDescription: "قائمة مختصرة للموقع مع إجراء رئيسي واضح.",
    },
    navigation: [
      { href: "/", label: "الرئيسية" },
    ...
    footer: {
      ...
      note: "للأعمال التي تريد وضوحاً أعلى وترتيباً أفضل واحتكاكاً تشغيلياً أقل.",
      ...
      process: {
        ...
        steps: [
          ...
          },
          {
            ...
            description:
              "نصمم وننفذ بهيكل نظيف ونطاق واضح مع تركيز على الملاءمة طويلة المدى.",
          },
          {
            step: "04",
    ...
    services: {
      ...
      detail: {
        ...
        overview: {
          eyebrow: "لمحة عن الخدمة",
          title: "حل عملي لاحتياج تشغيلي واضح.",
          description:
            "كل خدمة هنا مصممة لمعالجة جانب محدد من العمل يحتاج إلى ترتيب أو ربط أو تحسين واضح.",
          capabilitiesLabel: "ما الذي يدخل ضمن الخدمة",
        },
        problems: {
          eyebrow: "ما الذي تعالجه",
          title: "تركز على المشكلات التي تعطل العمل فعلياً.",
          description:
            "التركيز هنا على ما يؤثر على الوضوح والسرعة وجودة الخدمة والسيطرة اليومية على التشغيل.",
        },
        deliverables: {
          eyebrow: "ماذا يشمل العمل",
          title: "نطاق واضح، وتنفيذ مرتب، ونتيجة تصلح للاستخدام اليومي.",
          description:
        ...
        audience: {
          eyebrow: "متى تكون مناسبة",
          title: "مناسبة للأعمال التي تحتاج حلاً أوضح في هذا الجانب.",
          description:
            "غالباً تكون الأنسب للأعمال التي تجاوزت الأدوات المرتجلة أو أصبحت طريقة عملها أوضح من أن تخدمها الحلول العامة كما ينبغي.",
        },
        process: {
          eyebrow: "كيف نعمل",
          title: "خطوات واضحة من فهم الوضع حتى التنفيذ.",
          description:
        ...
        faq: {
          ...
          title: "أسئلة شائعة قبل بدء العمل على هذه الخدمة.",
          description:
            "النهج المناسب يعتمد على وضع النشاط، لكن هذه الإجابات تغطي أكثر الأسئلة التي تظهر في البداية.",
        },
        finalCta: {
          eyebrow: "الخطوة التالية",
          title: "إذا كانت هذه الخدمة هي الأقرب للاحتياج، فالخطوة التالية محادثة واضحة.",
          description:
            "تساعد Benyah على تحديد ما إذا كانت هذه الخدمة مناسبة الآن، أو إن كان من الأفضل ربطها بخدمة أخرى حتى يكتمل الحل.",
      ...
      items: {
        ...
        "workflow-systems-automation": {
          ...
          summary:
            "ربط أعمق بين الأنظمة والتدفقات التي تعتمد على أكثر من أداة أو منصة حتى تعمل معاً بصورة موثوقة.",
          heroSupportingLine:
            "مناسبة للأعمال التي تحتاج تحكماً أعمق في سير العمل، وربطاً أوثق بين الأنظمة، وتنفيذاً أكثر موثوقية.",
          intro:
            "هذه الخدمة مخصصة للأعمال التي تجاوزت الأتمتة البسيطة بين الخطوات. هنا تعمل Benyah على ربط النماذج والأنظمة الداخلية والبرامج المختلفة بحيث تتحرك البيانات والقرارات والإجراءات بالترتيب الصحيح. ويمكن استخدام n8n أو الـ webhooks أو الواجهات البرمجية متى كان ذلك هو الحل الأنسب.",
          capabilities: [
            "ربط بين النماذج وأنظمة إدارة العملاء والأدوات الداخلية والأنظمة التشغيلية",
            "تكاملات عبر n8n والـ webhooks والواجهات البرمجية عند الحاجة",
            "تنسيق أعمق للتفرعات والحالات وحركة البيانات بين الأنظمة",
          ],
          outcomes: [
          ...
          audience: [
            {
              ...
              description:
                "مناسبة عندما تحتاج النماذج أو أنظمة إدارة العملاء أو الأدوات الداخلية أو بقية الأنظمة إلى تكامل أعمق وحركة بيانات أكثر موثوقية.",
            },
            {
              title: "الفرق التي تحتاج ربطاً أعمق بين الأنظمة",
              description:
                "مفيدة عندما يحتاج التدفق إلى منطق أدق وتكاملات أعمق عبر الواجهات البرمجية أو الـ webhooks أو غيرها من وسائل الربط.",
            },
            {
    ...
    about: {
      eyebrow: "عن Benyah",
      title: "Benyah تقوم على فكرة الأساس الواضح.",
      description:
        "Benyah شركة حلول احترافية تساعد الأعمال الصغيرة والمتوسطة على ترتيب حضورها الرقمي وسير العمل وعملياتها من خلال أنظمة مترابطة.",
      supportingLine:
        "واجهة أوضح، وأنظمة أنظف، وتنفيذ عملي للأعمال التي تحتاج أن يعمل ما وراء العلامة كما ينبغي.",
      highlightsLabel: "جوهر Benyah",
      highlights: [
        "نفهم العمل قبل اختيار الأداة",
        "حلول مترابطة بدلاً من المعالجات المؤقتة",
        "تنفيذ راقٍ بوضوح تجاري",
      ],
      overview: {
        eyebrow: "من هي Benyah",
        title: "شريك يساعدك على ترتيب الواجهة الرقمية والتشغيل الداخلي معاً.",
        description:
      ...
      beliefs: {
        eyebrow: "المبادئ",
        title: "كلما اتضحت البنية، تحسن أداء العمل.",
        description:
      ...
      differentiators: {
        ...
        description:
          "Benyah لا تقوم على الحجم أو اللغة الرائجة أو الحل الواحد للجميع. القيمة تأتي من الفهم الصحيح والتنفيذ العملي.",
        items: [
          {
          ...
          },
          {
            ...
            description:
              "يُصاغ العمل حول الاعتماد والوضوح وملاءمة التشغيل حتى يدعم النشاط في الواقع لا في العرض فقط.",
          },
        ],
      },
      audience: {
        ...
        description:
          "غالباً تكون الملاءمة الأفضل للأعمال التي تجاوزت الأدوات المرتجلة أو التدفقات المنفصلة أو الواجهة الرقمية الضعيفة.",
        items: [
          {
      ...
      finalCta: {
        ...
        secondaryAction: "تعرّف على الخدمات",
      },
    },
    caseStudies: {
      eyebrow: "أعمال مختارة",
      title: "نماذج من الأعمال التي تنفذها Benyah.",
      description:
        "تعرض هذه الصفحة نماذج من نوع المشاريع التي تنفذها Benyah عبر الواجهة الرقمية وسير العمل وعمليات التشغيل.",
      supportingLine:
        "تُشارك التفاصيل الكاملة حين يكون ذلك مناسباً من حيث المرحلة والسرية وقابلية النشر.",
      highlightsLabel: "ما الذي ستجده هنا",
      highlights: [
        "نماذج عمل حقيقية من دون قصص عملاء مختلقة",
        "أمثلة توضح طبيعة المشاريع التي تنفذها Benyah",
        "صورة أوضح لكيفية تحديد نطاق العمل عادة",
      ],
      intro: {
        eyebrow: "كيف نعرض أعمالنا",
        title: "نعرض طريقة العمل بوضوح، لا بالمبالغة.",
        description:
          "تركز Benyah على العمل الذي يحسن الوضوح وسير العمل والسيطرة التشغيلية. الغرض من هذه الصفحة هو إعطاء صورة صادقة عن نوع العمل، لا صناعة رواية تسويقية.",
        asideEyebrow: "مبدأ النشر",
        asideTitle: "نشارك تفاصيل المشاريع بعناية، لا لمجرد الاستعراض.",
        asideDescription:
          "بعض المشاريع ما تزال قائمة، وبعضها سري، وبعضها يناقَش بصورة أفضل في تواصل مباشر. لذلك صُممت هذه الصفحة لتوضح نوع الأعمال التي تنفذها Benyah من دون اختلاق تفاصيل لا ينبغي نشرها.",
        asidePoints: [
          "نعرض المشروع من زاوية نوع الحل، لا من زاوية قصة عميل مختلقة",
          "تُشارك التفاصيل حين تكون المرحلة والملاءمة مناسبة",
          "يبقى التركيز على طريقة التنفيذ والقيمة التشغيلية",
        ],
      },
      startingPoints: {
      ...
      catalog: {
        ...
        title: "أمثلة تعكس طبيعة العمل الذي تنفذه Benyah.",
        description:
          "صيغت هذه الأمثلة بحسب نوع الحل حتى تبقى الصفحة مفيدة حتى قبل اتساع الأعمال المنشورة علناً.",
      },
      labels: {
        outcomeLabel: "النتيجة التي يخدمها",
        addressedLabel: "محور العمل",
        scopeLabel: "شكل التنفيذ المعتاد",
      },
      items: [
        {
          ...
          scope:
            "تنفيذ محدد النطاق أو تحسين لتدفق الحجز.",
        },
        {
        ...
        },
        {
          ...
          scope:
            "تنفيذ محدد النطاق أو إعادة بناء موقع بهيكل تحويل أوضح.",
        },
        {
        ...
        },
        {
          ...
          scope:
            "تنفيذ محدد النطاق أو إعداد نظام حول عملية داخلية عالية الاحتكاك.",
        },
        {
      ...
      engagements: {
        ...
        title: "تدعم Benyah المشاريع المحددة كما تدعم البنى التشغيلية متعددة الأجزاء.",
        description:
          "بعض المشاريع تبدأ من نقطة تعطل واحدة، وأخرى تحتاج إلى بنية أوسع عبر أكثر من طبقة داخل النشاط.",
        items: [
          {
      ...
      finalCta: {
        ...
        description:
          "تساعد Benyah على تحديد مستوى المشروع المناسب، وشكل الحل المرجح، وأفضل نقطة بداية بحسب وضع النشاط الحالي.",
        supportingLine: "فهم أوضح قبل التنفيذ.",
        secondaryAction: "تعرّف على الخدمات",
      },
    },
    book: {
      eyebrow: "جلسة تمهيدية",
      title: "اطلب جلسة تمهيدية لتوضيح الاحتياج والنطاق والخطوة التالية.",
      description:
        "الجلسة التمهيدية مع Benyah مخصصة لفهم طريقة عمل النشاط اليوم، وأين توجد نقاط التعطل، وما إذا كانت البداية الأنسب موقعاً أو تحسين سير عمل أو إعداد نظام أو بناء تشغيلي أوسع.",
      supportingLine:
      ...
      heroPrimaryAction: "اطّلع على الخيارات",
      heroSecondaryAction: "أو أرسل استفساراً",
      covers: {
        eyebrow: "ما الذي تتناوله الجلسة",
        title: "مراجعة سريعة للوضع الحالي وما يحتاجه النشاط.",
        description:
          "صُممت الجلسة لتمنح الطرفين قدراً كافياً من الوضوح حول الملاءمة، وطبيعة الاحتياج، والخطوة التالية.",
        items: [
          {
            title: "الوضع الحالي",
            description:
      ...
      audience: {
        ...
        description:
          "تكون الجلسة التمهيدية أكثر فائدة عندما يوجد احتياج واضح يحتاج إلى تعريف أو تحسين أو ترتيب صحيح.",
        items: [
          {
      ...
      booking: {
        ...
        description:
          "إذا كان تقويم الحجز المباشر متاحاً يمكنك اختيار موعد من هنا. وإذا لم يكن منشوراً حالياً، يمكنك طلب الجلسة التمهيدية مباشرة عبر نموذج التواصل من دون أن يتوقف النقاش.",
        shell: {
          configuredBadge: "التقويم متاح",
          configuredTitle: "حدّد موعد الجلسة",
          configuredDescription:
            "استخدم منطقة الحجز أدناه لاختيار وقت مناسب لنقاش أولي حول وضع النشاط والملاءمة والنطاق المرجح.",
          ...
          fallbackBadge: "طلب جلسة تمهيدية",
          fallbackTitle: "يمكن طلب الجلسة مباشرة.",
          fallbackDescription:
            "لإبقاء المسار واضحاً وعملياً، تُدار طلبات الجلسة التمهيدية عبر نموذج التواصل عندما لا يكون التقويم المباشر منشوراً هنا. يكفي أن ترسل نبذة مختصرة عن النشاط وتذكر أنك تفضل الجلسة.",
          fallbackPrimaryAction: "اطلب الجلسة",
          fallbackSecondaryAction: "تعرّف على الخدمات",
          fallbackNote:
      ...
      reassurance: {
        ...
        title: "الجلسة الأولى مخصصة لفهم الملاءمة والنطاق والخطوة التالية.",
        description:
        ...
        points: [
          ...
          "إذا لم تكن الجلسة التمهيدية هي الخطوة الأولى الأنسب، يمكن لـ Benyah اقتراح مسار أفضل",
    ...
    contact: {
      eyebrow: "التواصل",
      title: "ابدأ النقاش مع Benyah.",
      description:
        "تواصل بخصوص المواقع، أو الأتمتة، أو تدفقات الحجز والمكالمات الذكية، أو أنظمة الأعمال والأدوات الداخلية، أو حلول إدارة المرافق والصيانة، أو أي احتياج تشغيلي أوسع.",
      supportingLine:
        "تعمل Benyah على الحضور الرقمي وسير العمل والعمليات الداخلية للأعمال التي تحتاج أنظمة أوضح وتنفيذاً أفضل.",
      ...
      form: {
        ...
        nextStepOptions: [
          ...
          { value: "discovery-call", label: "طلب جلسة تمهيدية" },
        ],
        statuses: {
      ...
      finalCta: {
        ...
        description:
          "تساعد Benyah على تحديد ما إذا كانت الخطوة التالية موقعاً، أو تحسيناً لسير العمل، أو طبقة أتمتة، أو نظاماً تشغيلياً أوسع.",
        supportingLine: "وضوح قبل التنفيذ.",
